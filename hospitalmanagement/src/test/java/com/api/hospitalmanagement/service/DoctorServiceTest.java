...
public class DoctorServiceTest {
    ...
    public void setup() {
        ...
        user = new User();
        user.setUserId(101);
        user.setUserName("sundhar");

        doctor = new Doctor();
        doctor.setDoctorId(1);
        doctor.setName("sundharapandi");
        doctor.setUser(user);

        patient = new Patient();
        patient.setId(1);
        patient.setName("sundhar");
    ...
    public void testAddDoctor_Success() throws InvalidIDException {
        ...
        Doctor result = doctorService.add(101, doctor);
    ...
    public void testGetAllPatientByDocId_Success() throws InvalidIDException {
        ...
        List<Patient> result = doctorService.getallDoc(1);

        assertEquals(1, result.size());
        assertEquals("sundhar", result.get(0).getName());
